...
{
	public partial class AddGameCollectionControl : UserControl
	{
		public AddGameCollectionControl()
		{
			InitializeComponent();
		}
  ...
  ,{_1001}";
		...
		private void ButtonAddClick(object sender, EventArgs e)
		{
			...
			GamesControl.Instance.ShowGamesInGridAll();
		...
		{
			GamesControl.Instance.dgAll.RowFilter = $"Title LIKE '%{SQLHelper.EscapeSpecialCharacters(textBoxTitle.Text)}%'";
		}
	}
}